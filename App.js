...
export default class eventCalenderNew extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Container>
        ...
        >
          <Left style={{ flex: 1 }}>
            <Button
              transparent
              onPress={() => console.warn("Toogle Drawer open Pathik drawer")}
          ...
          <Right style={{ flex: 1 }}>
            <Button
              transparent
              onPress={() => console.warn("Hello open Pathik drawer")}
